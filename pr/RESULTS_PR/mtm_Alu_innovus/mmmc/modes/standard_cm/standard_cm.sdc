...
#  Generated on:      Sun Sep  8 20:52:29 2019
#  Design:            mtm_Alu
...
create_clock [get_ports {clk}]  -name _clk -period 20.000000 -waveform {0.000000 10.000000}
...
set_input_delay -add_delay 10 -clock [get_clocks {_clk}] [get_ports {rst_n}]
set_input_delay -add_delay 10 -clock [get_clocks {_clk}] [get_ports {sin}]
set_output_delay -add_delay 10 -clock [get_clocks {_clk}] [get_ports {sout}]
