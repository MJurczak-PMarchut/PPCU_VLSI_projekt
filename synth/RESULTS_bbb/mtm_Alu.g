...
# Created by Genus(TM) Synthesis Solution 17.13-s033_1 on Sun Sep 08 12:24:22 CEST 2019
...
set_db -quiet runtime_by_stage { {to_generic 2 23 2 10}  {first_condense 1 25 1 12}  {reify 2 27 1 14} }
...
set_db -quiet flow_metrics_snapshot_uuid 0a751e9d
...
# END DFT SECTION
set_db -quiet design:mtm_Alu .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 56953} {cell_count 1871} {utilization  0.00} {runtime 2 23 2 10} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 48337} {cell_count 1570} {utilization  0.00} {runtime 1 25 1 12} }{reify {wns 7553} {tns 0} {vep 0} {area 35471} {cell_count 915} {utilization  0.00} {runtime 2 27 1 14} }}
...
## Written on 12:24:22 08-Sep 2019
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 0a751e9d}
