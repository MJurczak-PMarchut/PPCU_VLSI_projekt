...
# Created by Genus(TM) Synthesis Solution 17.13-s033_1 on Sun Sep 08 12:46:43 CEST 2019
...
set_db -quiet runtime_by_stage { {to_generic 2 33 2 11}  {first_condense 2 35 1 13}  {reify 2 37 1 15} }
...
set_db -quiet flow_metrics_snapshot_uuid 0a77d816
...
# END DFT SECTION
set_db -quiet design:mtm_Alu .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 56953} {cell_count 1871} {utilization  0.00} {runtime 2 33 2 11} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 48337} {cell_count 1570} {utilization  0.00} {runtime 2 35 1 13} }{reify {wns 7553} {tns 0} {vep 0} {area 35471} {cell_count 915} {utilization  0.00} {runtime 2 37 1 15} }}
...
## Written on 12:46:43 08-Sep 2019
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 0a77d816}
