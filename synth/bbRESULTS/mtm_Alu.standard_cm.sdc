...
#  Created by Genus(TM) Synthesis Solution 17.13-s033_1 on Sun Sep 08 12:46:42 CEST 2019
...
set_load -pin_load 1.0 [get_ports sout]
...
set_output_delay -clock [get_clocks _clk] -add_delay 10.0 [get_ports sout]
