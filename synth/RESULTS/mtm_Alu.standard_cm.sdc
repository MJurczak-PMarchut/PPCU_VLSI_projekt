...
#  Created by Genus(TM) Synthesis Solution 17.13-s033_1 on Sun Sep 08 20:46:42 CEST 2019
...
create_clock -name "_clk" -add -period 20.0 -waveform {0.0 10.0} [get_ports clk]
set_load -pin_load 0.1 [get_ports sout]
set_clock_gating_check -setup 0.0 
set_input_delay -clock [get_clocks _clk] -add_delay 10.0 [get_ports clk]
set_input_delay -clock [get_clocks _clk] -add_delay 10.0 [get_ports rst_n]
set_input_delay -clock [get_clocks _clk] -add_delay 10.0 [get_ports sin]
set_output_delay -clock [get_clocks _clk] -add_delay -min 10.0 [get_ports sout]
set_output_delay -clock [get_clocks _clk] -add_delay -max 10.0 [get_ports sout]
