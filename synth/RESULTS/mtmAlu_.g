...
# Created by Genus(TM) Synthesis Solution 17.13-s033_1 on Sun Sep 08 04:11:30 CEST 2019
...
set_db -quiet runtime_by_stage { {to_generic 2 26 2 10}  {first_condense 2 28 1 12}  {reify 2 30 1 14} }
...
set_db -quiet flow_metrics_snapshot_uuid 0a752ed0
...
# END DFT SECTION
set_db -quiet design:mtm_Alu .qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 56953} {cell_count 1871} {utilization  0.00} {runtime 2 26 2 10} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 48337} {cell_count 1570} {utilization  0.00} {runtime 2 28 1 12} }{reify {wns 7553} {tns 0} {vep 0} {area 35471} {cell_count 915} {utilization  0.00} {runtime 2 30 1 14} }}
...
## Written on 04:11:30 08-Sep 2019
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_db flow_metrics_snapshot_uuid 0a752ed0}
