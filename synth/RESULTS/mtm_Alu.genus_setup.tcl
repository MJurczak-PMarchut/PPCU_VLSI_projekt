...
if {$_slk_ != "7933.0"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 7933.0,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:mtm_Alu]]" != "{{mode:mtm_Alu/WC_av 7933.0}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:mtm_Alu/WC_av 7933.0}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:mtm_Alu]]"
}
# tns
...
if {$_cell_area_ != "34795"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 34795,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "12516"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 12516,  current net area: $_net_area_"
}
unset _net_area_
