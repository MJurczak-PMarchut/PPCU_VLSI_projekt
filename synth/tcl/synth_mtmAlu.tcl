...
# read_hdl 
read_hdl -v2001 ../rtl/mtm_Alu.v ../rtl/mtm_Alu_core.v ../rtl/mtm_Alu_deserializer.v ../rtl/mtm_Alu_serializer.v 
#suspend
...
puts "--------------------------------------------------------------------------------"
check_timing_intent
check_timing_intent -verbose > timing_intent_report.rpt
#
...
write_design -innovus -basename $resultDir/mtm_Alu
