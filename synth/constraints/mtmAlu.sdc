...
# TODO: create_clock 
create_clock -name "_clk" -period 20 -waveform {0.0 10.0} clk
...
set_input_delay 10 -clock [get_clocks _clk] [all_inputs]
...
set_output_delay 10 -clock [get_clocks _clk] [all_outputs]
set_output_delay -clock clk -max 10 [get_ports sout]
set_output_delay -clock _clk -max 10 [get_ports sout]
# TODO: set_load 
